...
@Composable
fun BerandaScreen(
    nav: NavHostController, // tetap diteruskan kalau butuh
    vm: AuthViewModel = hiltViewModel(),
    onMahasiswaClick: (String) -> Unit // callback saat mahasiswa diklik
) {
            ...
            Surface(
                modifier = Modifier
                    ...
                    .clickable {
                        ...
                        onMahasiswaClick(mhs.nim)  // pake callback, jangan nav.navigate langsung
                    },
                tonalElevation = 2.dp,
